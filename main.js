...
const CONFIG = {
    ...
    numExtrusions: 160,       // Number of shadow extrusions to generate
    ...
    animationSpeed: 12         // Number of frames per day change (higher = slower animation)
};
                ...
                for (let timeIndex = 0; timeIndex < timeSamples; timeIndex++) {
                    ...
                    if (sunDirForExtrusion.y > 0) { // Only add if sun is above horizon
                        ...
                        if (CONFIG.showDummyMesh) {
                            ...
                            const dummyExtrusionMesh = dummyExtruder.createMesh(sunDirForExtrusion, CONFIG.extrusionDistance);
                        ...
                        if (CONFIG.showImportedMesh) {
                            ...
                            const objExtrusionMesh = objExtruder.createMesh(sunDirForExtrusion, CONFIG.extrusionDistance);
